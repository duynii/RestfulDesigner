...
<html lang="en">
	...
	<body class="claro">
		...
		<script>
			require(["app_demo5/app_step5", "dijit/layout/BorderContainer", "dijit/layout/TabContainer", "dijit/layout/ContentPane", "dojox/data/FlickrRestStore", "dojo/domReady!"], function(demoApp) {
				demoApp.init();
			});
		</script>
	</body>
